...
<div class="page-title">
    ...
    <a href="{{ route('dashboard::Paymentvente.create',$Invoicevente->    reference_cmd)}}">
    ...
    <div class="col-md-14">
        <div class="grid simple ">
            <div class="grid-title no-border">
                ...
                <a href="{{route('dashboard::Invoicevente.index')}}" class="remove"></a>
        ...
        <div class="grid-body no-border">
            <table class="table no-more-tables">
                ...
                <tbody>
                    @foreach($Paymentventes as $payment) 
                    <tr>
                        ...
                        <td>{{$payment->type}}</td>
                        <td>{{$payment->payer}} </td>
                        <td>{{substr($payment->description,0,10)}}...</td>
                        <!--  button -->
                        <td>
                            ...
                            <!-- button -->
        <a href=""   class="btn btn-danger" data-toggle="modal" data-target="#modal{{$payment->id}}">
                                <span class="glyphicon glyphicon-trash  "  style=""></span>
               </a>
                            
<a href="{{route('dashboard::Paymentvente.show',[$payment->id,$Invoicevente->id])}}" class="btn btn-success " style="">
                                <span class="glyphicon glyphicon-fullscreen "  style=""></span>
                            </a>
                            <a href="{{route('dashboard::Paymentvente.PDF',[$payment->id,$Invoicevente->id])}}"   >
...
<!--model conferm supp-->
    ...
    <div class="modal-dialog"  style="margin-top: 26%;">
        ...
        <a href="{{route('dashboard::Paymentvente.destroy',[$payment->id,$Invoicevente->id])}}" >
