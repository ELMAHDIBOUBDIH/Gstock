...
@section('content')
    ...
    <h3>{{ trans('text.add-provider')}}</h3>        
        ...
        <div class="add-element box">
            ...
            @endif
            <form class="form-horizontal" action="{{route('dashboard::provider.store')}}"
                ...
                <div class="{{ $errors->has('name_society') ? 'form-group has-error' :'form-group'}}">
                    ...
                    <div class="col-sm-7">
                        ...
                        name="name_society" value="{{Request::old('name_society')}}" maxlength="30" required>
                    </div>
                </div>
                ...
                <div class="{{ $errors->has('mail') ? 'form-group has-error' :'form-group'}}">
                    ...
                    <div class="col-sm-7">
                        ...
                        name="mail" value="{{Request::old('mail')}}" >
                    </div>
                </div>
