...
<div class="grid simple ">
    ...
    <div class="grid-body no-border">
        <div class="add-element box">
            ...
            @endif
            <h4> <span class="semi-bold" >{{ trans('text.payement')}}</span></h4>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="form1Name" 
                         value="{{$commande_achat->id}}" name="cmd_id" readonly="">
                    </div>
                    <div class="form-group">
                    <div class="col-sm-7">
                        <input type="hidden" class="form-control" id="form1Name" 
                         value="{{$commande_achat->Invoice->id}}" name="invoice_id" >
                    </div>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="form1Name" value="{{$commande_achat->total}}"
                        name="total"  readonly="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
        <input type="text" class="form-control" id="form1Name" name="rest" value="{{$commande_achat->Invoice->credit}}" readonly="">
                    </div>
                </div >
                ...
                <div class="{{ $errors->has('payer') ? 'form-group has-error' :'form-group'}}">
                    ...
                    <div class="col-sm-7">
                        ...
                        name="payer" min="0" max="{{$commande_achat->Invoice->credit}}" required>
                    </div>
                </div>
                <div class="form-group">
